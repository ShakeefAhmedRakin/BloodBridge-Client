const Featured = () => {
  return (
    <>
      <div className="bg-background gap-7 px-4 md:px-6 border-2 grid grid-cols-1 xl:grid-cols-2 font-heading py-6 rounded-xl shadow-xl">
        <div>
          <img
            src="/pexels-karolina-grabowska-4226921.jpg"
        ...
        <div>
          ...
          <hr />
          <p>
            At <span className="text-accent font-bold">BloodBridge</span>, we
