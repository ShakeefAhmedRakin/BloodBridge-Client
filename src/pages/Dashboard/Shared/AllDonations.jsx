...
const AllDonations = () => {
  ...
  useEffect(() => {
    axiosSecure
      .get(`/admin/donation-requests/count?filter=${filter}`)
  ...
  useEffect(() => {
    axiosSecure
      .get(
        `/admin/donation-requests?filter=${filter}&page=${currentPage}&size=${itemsPerPage}`
      )
  ...
  return (
    <>
      <Helmet>
        <title>BloodBridge | All Requests</title>
      </Helmet>
